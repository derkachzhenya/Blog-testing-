    ...
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="hidden items-center gap-2 text-sm text-gray-400 md:flex">
                ...
                <span>/</span>
                <a class="font-medium text-sky-600 transition hover:text-sky-700" href="{{ route('category.index') }}">
                    Categories
                </a>
                <span>/</span>
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Category preview and metadata.</p>
                            </div>
                        </div>
                ...
                <div class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-gray-200/80 sm:p-8">
                    <div class="border-b border-gray-100 pb-5">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            Basic information stored for this category.
                        </p>
                    </div>

                    <dl class="mt-6 grid gap-4 sm:grid-cols-2">
                        <div class="rounded-[1.5rem] bg-gray-100 px-5 py-4">
                            <dt class="text-xs uppercase tracking-[0.2em] text-gray-500">Title</dt>
                            <dd class="mt-2 text-base font-medium text-gray-900">{{ $category->title }}</dd>
                        </div>

                        <div class="rounded-[1.5rem] bg-gray-100 px-5 py-4">
                            <dt class="text-xs uppercase tracking-[0.2em] text-gray-500">Created</dt>
                            <dd class="mt-2 text-base font-medium text-gray-900">{{ $category->created_at?->format('d.m.Y H:i') }}</dd>
                        </div>
                    </dl>
                </div>
            </section>
