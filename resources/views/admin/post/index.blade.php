    ...
    <div class="bg-gray-100 py-8">
        <div class="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:px-6 lg:flex-row lg:px-8" x-data="{ sidebarOpen: true }">
            ...
            <section class="flex-1 space-y-6">
                @if (session('status'))
                    <div class="rounded-[1.5rem] border border-emerald-200 bg-emerald-50 px-5 py-4 text-sm font-medium text-emerald-700 shadow-sm">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                <div class="rounded-[2rem] bg-white p-4 shadow-sm ring-1 ring-gray-200/80 sm:p-5">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-lg font-semibold text-gray-900">Post management</p>
                                <p class="text-sm text-gray-500">Create, edit, view, and delete posts.</p>
                            </div>
                        </div>
                ...
                <div class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-gray-200/80 sm:p-8">
                    <div class="flex flex-col gap-3 border-b border-gray-100 pb-5">
                        ...
                        <p class="max-w-2xl text-sm text-gray-500">
                            Manage post titles, content, categories, and tags from one screen.
                        </p>
                    </div>

                    @if ($posts->isEmpty())
                        <div class="mt-6 rounded-[1.5rem] border border-dashed border-gray-300 bg-gray-50 px-6 py-10 text-center">
                            <p class="text-base font-medium text-gray-700">No post content yet</p>
                            <p class="mt-2 text-sm text-gray-500">
                                Create the first post and connect it with a category or tags.
                            </p>
                        </div>
                    @else
                        <div class="mt-6">
                            <ul class="space-y-3">
                                @foreach ($posts as $post)
                                    <li class="flex flex-col gap-4 rounded-[1.5rem] bg-gray-100 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
