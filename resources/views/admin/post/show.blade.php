        ...
        <div class="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:px-6 lg:flex-row lg:px-8" x-data="{ sidebarOpen: true }">
            ...
            <section class="flex-1 space-y-6">
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Post preview and metadata.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row">
                            ...
                            <a
                                class="inline-flex items-center justify-center rounded-2xl bg-amber-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-amber-600"
                ...
                <div class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_20rem]">
                    <article class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-gray-200/80 sm:p-8">
                        <div class="border-b border-gray-100 pb-5">
                            <h3 class="text-lg font-semibold text-gray-900">Post content</h3>
                            <p class="mt-2 text-sm text-gray-500">
                                Full body stored for this post.
                            </p>
                        </div>

                        <div class="prose prose-slate mt-6 max-w-none">
                            <p class="whitespace-pre-line text-sm leading-7 text-gray-700">{{ $post->content }}</p>
                        </div>
                    </article>

                    <aside class="space-y-6">
                        <div class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-gray-200/80 sm:p-7">
                            <h3 class="text-lg font-semibold text-gray-900">Post details</h3>

                            <dl class="mt-5 space-y-3">
                                <div class="rounded-[1.5rem] bg-gray-100 px-5 py-4">
                                    <dt class="text-xs uppercase tracking-[0.2em] text-gray-500">Category</dt>
                                    <dd class="mt-2 text-sm font-medium text-gray-900">{{ $post->category?->title ?? 'No category' }}</dd>
                                </div>

                                <div class="rounded-[1.5rem] bg-gray-100 px-5 py-4">
                                    <dt class="text-xs uppercase tracking-[0.2em] text-gray-500">Created</dt>
                                    <dd class="mt-2 text-sm font-medium text-gray-900">{{ $post->created_at?->format('d.m.Y H:i') }}</dd>
                                </div>
                            </dl>
                        </div>

                        <div class="rounded-[2rem] bg-slate-900 p-6 text-white shadow-sm sm:p-7">
                            <p class="text-xs uppercase tracking-[0.3em] text-sky-300">Tags</p>
