                ...
                <div class="rounded-[2rem] bg-white p-4 shadow-sm ring-1 ring-gray-200/80 sm:p-5">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-lg font-semibold text-gray-900">Tag management</p>
                                <p class="text-sm text-gray-500">This screen is prepared for the tag list.</p>
                            </div>
                        </div>
                ...
                <div class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-gray-200/80 sm:p-8">
                    <div class="flex flex-col gap-3 border-b border-gray-100 pb-5">
                        ...
                        <p class="max-w-2xl text-sm text-gray-500">
                            ...
                            or form here when tag CRUD is ready.
                        </p>
                    </div>
                    @if($tags->isEmpty())
                        <div
                            class="mt-6 rounded-[1.5rem] border border-dashed border-gray-300 bg-gray-50 px-6 py-10 text-center">
                            <p class="text-base font-medium text-gray-700">No tag content yet</p>
                            <p class="mt-2 text-sm text-gray-500">
                                The template is clean now and ready for a tags table.
                            </p>
                        </div>
                    @else
                        <div class="mt-6">
