                ...
                <div class="rounded-[2rem] bg-white p-4 shadow-sm ring-1 ring-gray-200/80 sm:p-5">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-lg font-semibold text-gray-900">{{ $tag->title }}</p>
                                <p class="text-sm text-gray-500">Tag preview and metadata.</p>
                            </div>
                        </div>
                ...
                <div class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-gray-200/80 sm:p-8">
                    <div class="border-b border-gray-100 pb-5">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            Basic information stored for this tag.
                        </p>
                    </div>
                    ...
                    <dl class="mt-6 grid gap-4 sm:grid-cols-2">
                        <div class="rounded-[1.5rem] bg-gray-100 px-5 py-4">
                            ...
                            <dd class="mt-2 text-base font-medium text-gray-900">{{ $tag->title }}</dd>
                        </div>

                        <div class="rounded-[1.5rem] bg-gray-100 px-5 py-4">
                            <dt class="text-xs uppercase tracking-[0.2em] text-gray-500">Created</dt>
                            <dd class="mt-2 text-base font-medium text-gray-900">{{ $tag->created_at?->format('d.m.Y H:i') }}</dd>
                        </div>
                    </dl>
                </div>
            </section>
